...
//	private String imgurl_test="http://www.zrytech.com/nopshop/File/Banners/1_20170713190223_thumb.jpg";
	 ...
	 * @param list
	 */
	public MessageAdapter(Context context, List<MessageType> list) {
		this.context = context;
		inflater = LayoutInflater.from(context);
		this.setList(list);

	}
	public MessageAdapter(Context context, List<MessageType> list, int type) {
		this.context = context;
		inflater = LayoutInflater.from(context);
		this.setList(list);
		this.type=type;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.tvMsgName.setText(mt.getTitle());
		holder.tvMsgDes.setText(mt.getContent());
