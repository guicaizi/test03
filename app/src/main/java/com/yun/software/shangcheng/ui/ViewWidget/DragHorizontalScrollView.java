...
/**
 * Created by yanliang on 2016/7/13.
 */
public class DragHorizontalScrollView extends HorizontalScrollView {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                // 是否应该移动布局
                boolean shouldMove = (canPullDown && deltaX > 0) // 可以下拉， 并且手指向下移动
                        || (canPullUp && deltaX < 0) // 可以上拉， 并且手指向上移动
    ...
    private boolean isCanPullDown() {
        ...
        // 像右移动小于零  这里如果向右移动getScrollx()小于零  所以会移动到左边缘
    ...
    private boolean isCanPullUp() {
        // 像左移动小于零  这里如果向右移动getScrollx()小于零  所以会移动到右边缘
