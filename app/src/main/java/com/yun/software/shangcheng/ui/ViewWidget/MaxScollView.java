...
public class MaxScollView extends ScrollView {
    private static final String TAG = "MyScrollview";

    private OnScrollListener listener;
    private int lastScrollY;

    public MaxScollView(Context context) {
        super(context);
    }

    public MaxScollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MaxScollView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            int scrollY = MaxScollView.this.getScrollY();
