...
public class MultiImageView extends LinearLayout {
	...
	private int pxImagePadding = ScreenUtil.dip2px(3);// 图片间的间距
	...
	private void initImageLayoutParams() {
        ...
        //pxOneMaxWandH
//		onePicPara = new LayoutParams(wrap,match/2);
	...
	private ImageView createImageView(int position, final boolean isMultiImage) {
		...
		if(isMultiImage){
			...
			onePicPara=new LayoutParams(ScreenUtil.dip2px(200), ViewGroup.LayoutParams.WRAP_CONTENT);
			onePicPara.gravity= Gravity.LEFT;
			imageView.setAdjustViewBounds(true);
			imageView.setScaleType(ScaleType.FIT_CENTER);
			imageView.setMaxHeight(ScreenUtil.dip2px(220));
		...
		GlidUtils.loadRoundImageView(getContext(),url,imageView, ScreenUtil.dip2px(3));
