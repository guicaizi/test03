...
//    }
//
//    public <T> void request(Activity activity, int what, Request<T> request, HttpListener callback, boolean canCancel, boolean isLoading) {
//        mRequestQueue.add(what, request, new HttpResponseListener<T>(activity, request, callback, canCancel, isLoading));
//    }
