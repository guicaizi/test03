...
/**
 * Created by yanliang on 2017/6/17.
 */
public class DropDownMenu extends LinearLayout {
    ...
    public DropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        a.recycle();
        //为tabMenuView添加下划线
        View underLine1 = new View(getContext());
        underLine1.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, dpTpPx(1.0f)));
        underLine1.setBackgroundColor(underlineColor);
        addView(underLine1,0);
